...
#define EBADRUNMASK     315 /* Invalid runmask                         */
#define ECTX            316 /* Invalid context */

#define ENOERROR        (-1)   /* Error is ignored (internal use) */
#define EKCALLRESTART   (-2)   /* Restart the kernel call (internal use) */
#endif
