...
#ifdef __EXT_LF64SRC
extern int ftw64(const char *__path, int (*__fn)(const char *__fname, const struct stat64 *__sbuf, int __flag), int __fd_limit) __ALIASOFF("ftw");
extern int nftw64(const char *__path, int (*__fn)(const char *__fname, const struct stat64 *__sbuf, int __flag, struct FTW *__ftw), int __fd_limit, int __flags) __ALIASOFF("nftw");
#if defined(__EXT_LF64ALIAS) && !defined(__ALIAS_ATTRIBUTE)
#error ALIAS not configured for compiler: ftw,nftw
#endif
#endif

extern int ftw(const char *__path, int (*__fn)(const char *__fname, const struct stat *__sbuf, int __flag), int __fd_limit) __ALIAS64("ftw64");
extern int nftw(const char *__path, int (*__fn)(const char *__fname, const struct stat *__sbuf, int __flag, struct FTW *__ftw), int __fd_limit, int __flags) __ALIAS64("nftw64");
