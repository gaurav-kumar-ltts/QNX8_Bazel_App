...
/*
 ===============================================================================
 MSI capability specific APIs

 MSI APIs that may be called from an interrupt handler, have an '_isr' suffix

*/

/* the following APIs allow driver software to configure the MSI capabilities */
