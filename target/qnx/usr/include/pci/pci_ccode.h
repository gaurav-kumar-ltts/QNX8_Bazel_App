...
#define PCI_CCODE_MEMORY_CXL_MEM_VEND_IF	PCI_CCODE(PCI_CCODE_MEMORY, 0x02, 0x00)
#define PCI_CCODE_MEMORY_CXL_MEM_V2			PCI_CCODE(PCI_CCODE_MEMORY, 0x02, 0x10)
...
#define PCI_CCODE_PERIPHERAL_TIMECARD_VEND_IF	PCI_CCODE(PCI_CCODE_PERIPHERAL, 0x08, 0x00)
#define PCI_CCODE_PERIPHERAL_TIMECARD_OCP_TAP_IF	PCI_CCODE(PCI_CCODE_PERIPHERAL, 0x08, 0x01)
...
#define PCI_CCODE_SBUS_CXL_FAB_MGMT_HOST_IF		PCI_CCODE(PCI_CCODE_SBUS, 0x0B, 0x00)
...
#define PCI_CCODE_CRYPT_TPM					PCI_CCODE(PCI_CCODE_CRYPT, 0x20, 0x00)
...
#define PCI_CCODE_ACCELERATOR_SNIA_SDXI		PCI_CCODE(PCI_CCODE_ACCELERATOR, 0x01, 0x00)
