 ...
 */
void kalman_d(double x_pos, double y_pos, double * x_post, double * p_post, double q_var_x, double q_var_y, double r_var_x, double r_var_y);

#endif /* KALMAN_H_ */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/lib/input/kalman/public/kalman.h $ $Rev: 904458 $")
#endif
