...
#ifndef NO_QNXSPEC
#define TPM2_MAX_PTT_PROPERTIES ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - sizeof(UINT32)) / sizeof(UINT32))
#else
...
#ifndef NO_QNXSPEC
#define TPM2_MAX_AC_CAPABILITIES ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - sizeof(UINT32)) / sizeof(TPMS_AC_OUTPUT))
#else
...
__SRCVERSION("$URL: http://f27svn.qnx.com/svn/repos/osr/trunk/tcg/intel_tpm2-tss/dist/include/tss2/tss2_tpm2_types.h $ $Rev: 3464 $")
#endif
