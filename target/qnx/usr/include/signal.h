...
#define SIGDOOM     32  /* target thread unable to process signal */
...
# define MAXSIG      _SIGMAX    /* Signals from NSIG to MAXSIG are reserved. */
#endif
...
#define SA_ONSTACK      0x0008  /* Handle signal on signal stack */
...
#define MINSIGSTKSZ (3UL * 1024UL)
#define SIGSTKSZ    (64UL * 1024UL)
...
extern int sigaltstack(stack_t const * __restrict __ss, stack_t * __restrict __oss);
#endif
