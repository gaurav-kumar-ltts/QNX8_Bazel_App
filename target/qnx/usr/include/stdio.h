...
#define FILENAME_MAX    __PATH_MAX  /*  size of array needed to hold longest file name string */
...
extern int fprintf(FILE *__fp, const char *__format, ...) __attribute__((__format__(__printf__, 2, 3)));
...
extern int fscanf(FILE*__fp, const char *__format, ...) __attribute__((__format__(__scanf__, 2, 3)));
...
extern int printf(const char *__format, ...) __attribute__((__format__(__printf__, 1, 2)));
...
extern int scanf(const char *__format, ...) __attribute__((__format__(__scanf__, 1, 2)));
extern void setbuf(FILE *__fp, char *__buf);
extern int setvbuf(FILE *__fp, char *__buf, int __mode, size_t __size);
extern int sprintf(char *__s, const char *__format, ...) __attribute__((__format__(__printf__, 2, 3)));
extern int snprintf(char *__s, size_t __size, const char *__format, ...) __attribute__((__format__(__printf__, 3, 4)));
extern int sscanf(const char *__s, const char *__format, ...) __attribute__((__format__(__scanf__, 2, 3)));
extern FILE *tmpfile(void) __ALIAS64("tmpfile64");
extern char *tmpnam(char *__s);
extern int ungetc(int __c, FILE *__fp);
extern int vfprintf(FILE *__fp, const char *__format, __NTO_va_list __arg) __attribute__((__format__(__printf__, 2, 0)));
extern int vprintf(const char *__format, __NTO_va_list __arg) __attribute__((__format__(__printf__, 1, 0)));
extern int vsprintf(char *__s, const char *__format, __NTO_va_list __arg) __attribute__((__format__(__printf__, 2, 0)));
