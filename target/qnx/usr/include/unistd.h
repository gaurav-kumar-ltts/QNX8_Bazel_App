...
#if defined(__PID64_T)
typedef __PID64_T		pid64_t;
#undef __PID64_T
#endif
...
#elif defined(__EXT_POSIX1_200112)
...
static __ALWAYS_INLINE __ARTIFICIAL void __setiov_const(iov_t * const __iov, const void * const __addr, const size_t __len)
{
    __iov->iov_base_const = __addr;
    __iov->iov_len = __len;
}

static __ALWAYS_INLINE __ARTIFICIAL void __setiov(iov_t * const __iov, void * const __addr, const size_t __len)
{
    __iov->iov_base = __addr;
    __iov->iov_len = __len;
}

# ifndef SETIOV_CONST
#  define SETIOV_CONST(__iov, __addr, __len)  (__setiov_const((__iov), (__addr), (__len)))
# endif

# ifndef SETIOV
#  define SETIOV(__iov, __addr, __len)  (__setiov((__iov), (__addr), (__len)))
# endif

# ifndef GETIOVBASE_CONST
#  define GETIOVBASE_CONST(__iov)  ((__iov)->iov_base_const)
# endif

# ifndef GETIOVBASE
#  define GETIOVBASE(__iov)  ((__iov)->iov_base)
# endif

# ifndef GETIOVLEN
#  define GETIOVLEN(__iov)  ((__iov)->iov_len)
# endif
...
extern ssize_t readlinkat(int __dirfd, const char *__pathname, char *__buf, size_t __bufsize);
...
extern int pipe2(int __fildes[2], int __flags);
extern pid64_t getpid64(pid_t pid);
