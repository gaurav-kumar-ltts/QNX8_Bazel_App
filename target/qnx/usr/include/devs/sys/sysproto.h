...
#else
	char msg_l_[PADL_(const struct msghdr *)]; struct msghdr * msg; char msg_r_[PADR_(const struct msghdr *)];
#endif 
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
...
#else /* !__QNXNTO__ */
	char rsv_l_[PADL_(struct file **)]; struct file ** rsv; char rsv_r_[PADR_(struct file **)];
#endif /* __QNXNTO__ */
};
struct mkdir_args {
	char path_l_[PADL_(const char *)]; const char * path; char path_r_[PADR_(const char *)];
