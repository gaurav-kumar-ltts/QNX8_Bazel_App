...
#define PTHREAD_STACK_FREE        0x800

#define PTHREAD_CANCELED ((void *)-1)

#define PTHREAD_DEFAULT_STACKSIZE      0x40000u
...
#define PTHREAD_PARENT_PRIORITY     (-1)
#define PTHREAD_PARENT_CURPRIORITY  (-2)
...
extern size_t pthread_attr_getdefaultstacksize(void);
extern int pthread_attr_setdefaultstacksize(size_t __stacksize);
extern size_t pthread_attr_getdefaultguardsize(void);
extern int pthread_attr_setdefaultguardsize(size_t __guardsize);
#if defined(__SLIB_DATA_INDIRECT) && !defined(pthread_attr_default) && !defined(__SLIB)
  pthread_attr_t * __get_pthread_attr_default_ptr(void);
  #define pthread_attr_default (pthread_attr_t)(*(__get_pthread_attr_default_ptr()))
#else
...
extern int pthread_cluster_get_runmask(char const *__name, _Uint64t *__runmask);
extern int pthread_cluster_set(pthread_t __thr, char const *__name);
extern int pthread_cluster_set_and_inherit(pthread_t __thr, char const *__name, char const *__inherit_name);
#endif
...
#endif
#if defined(__EXT_QNX)
#define PTHREAD_RMUTEX_INITIALIZER				\
	{ .__u = { .__count = 0U }, .__owner = _NTO_SYNC_MUTEX_FREE }
#define PTHREAD_MUTEX_WAKEUP_INITIALIZER								\
	{ .__u = { .__count = _NTO_SYNC_NONRECURSIVE | _NTO_SYNC_WAKEUP },	\
	  .__owner = _NTO_SYNC_INITIALIZER }
#define PTHREAD_RMUTEX_WAKEUP_INITIALIZER					\
	{ .__u = { .__count = _NTO_SYNC_WAKEUP }, .__owner = _NTO_SYNC_INITIALIZER }
#endif
...
extern int pthread_mutex_clocklock(pthread_mutex_t *const __mutex, clockid_t __clk, const struct timespec *const __abstime);
#endif
...
#endif
#if defined(__EXT_XOPEN_EX) || defined(__EXT_POSIX1_200809)
...
extern int pthread_cond_clockwait(pthread_cond_t *__cond, pthread_mutex_t *__mutex, clockid_t __clk, const struct timespec *__abstime);
#endif
#endif
...
#ifdef __INLINE_FUNCTIONS__
#define pthread_once(_c, _f)	((__atomic_load_n(&(_c)->__once, __ATOMIC_ACQUIRE) != 0) ? 0 : __pthread_once((_c),(_f)) )
#endif
...
typedef sync_t  pthread_barrier_t;
...
pthread_rwlockattr_getclock(const pthread_rwlockattr_t *__attr, clockid_t *__id);
extern int  __attribute__ ((deprecated))
pthread_rwlockattr_setclock(pthread_rwlockattr_t *__attr, clockid_t __id);
#endif
...
extern int pthread_rwlock_clockrdlock(pthread_rwlock_t *__lock, clockid_t __clk, const struct timespec *__abs_timeout);
extern int pthread_rwlock_wrlock(pthread_rwlock_t *);
extern int pthread_rwlock_trywrlock(pthread_rwlock_t *);
extern int pthread_rwlock_timedwrlock(pthread_rwlock_t *, const struct timespec *__abs_timeout);
extern int pthread_rwlock_clockwrlock(pthread_rwlock_t *__lock, clockid_t __clk, const struct timespec *__abs_timeout);
...
extern int __attribute__ ((deprecated)) pthread_abort(pthread_t __thr);
#endif

#if defined(__EXT_QNX)
/* QNX Extensions */
#define PTHREAD_BARRIER_INITIALIZER(__b)       \
       { .__owner = _NTO_SYNC_BARRIER, .__u = { .__count = (__b) } }

/* In UNIX98, but removed for alignment with approved 1003.1j */
#define PTHREAD_RWLOCK_INITIALIZER	{ .__u = { .__count = 0U }, .__owner = 0U }
