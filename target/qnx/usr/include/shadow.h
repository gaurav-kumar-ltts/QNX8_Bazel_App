...
extern struct spwd   *getspent_r(struct spwd *result, char *buffer, size_t buflen);
extern struct spwd   *getspnam(char *name);
extern struct spwd   *getspnam_r(const char *name, struct spwd *result, char *buffer, size_t buflen);
