...
#define SLOG2_PACKET_FLAGS_MONOTONIC   0x00000002 /*!< timestamp source is based on CLOCK_MONOTONIC */
...
#define SLOG2_PARSE_SETTINGS_VERBOSE                        (1U) /*!< parameter:none */
#define SLOG2_PARSE_SETTINGS_NOTIFY_POLL_INTERVAL           (2U) /*!< parameter:uint32_t:milliseconds */
/**
 * applies global settings
 * @param setting     setting option
 * @param ...         certain setting options require a parameter
 * @return  0 on success, -1 on failure.
 */
int slog2_parse_settings( _Uint32t __setting, ... );
