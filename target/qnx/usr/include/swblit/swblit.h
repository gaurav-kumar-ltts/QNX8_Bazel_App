...
#define SWBLIT_FMT_FLAG_RB_SWIZZLE_LOC  0x10000000

#define SWBLIT_FMT_REQUIRES_SWIZZLE(__fmt) \
    ((__fmt) & SWBLIT_FMT_FLAG_RB_SWIZZLE_LOC)
...
typedef enum {
    ...
    SWBLIT_FMT_R8G8B8X8 = 32 | SWBLIT_FMT_FLAG_ALPHA_LOC | SWBLIT_FMT_FLAG_RB_SWIZZLE_LOC,
    ...
    SWBLIT_FMT_R8G8B8A8 = 32 | SWBLIT_FMT_FLAG_ALPHA_LOC | SWBLIT_FMT_FLAG_ALPHA_VAL | SWBLIT_FMT_FLAG_RB_SWIZZLE_LOC,
 ...
 *
 */
int swblit_surface_desc_init(swblit_surface_desc_t surf,
        int width,
        int height,
        unsigned stride,
        void *vaddr,
