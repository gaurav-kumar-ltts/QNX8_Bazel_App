...
CC_nto_x86_64_gcc += -c -Wall -pipe $(DEBUG) $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(FORTIFY_DEFS)
AS_nto_x86_64_gcc += -c -Wall -pipe -O $(addprefix -Wa$(comma)-I, $(INCDIRS)) $(addprefix -D,$(VARIANT_NAMES))
AR_nto_x86_64_gcc += -r
CC_nto_x86_64_gcc_qcc += -Wc,-Wall $(DEBUG) $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(FORTIFY_DEFS)
AS_nto_x86_64_gcc_qcc += -O $(addprefix -Wa$(comma)-I, $(INCDIRS)) $(addprefix -D,$(VARIANT_NAMES))

CC_nto_x86_64_clang += -c -Wall -pipe $(DEBUG) $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(FORTIFY_DEFS)
