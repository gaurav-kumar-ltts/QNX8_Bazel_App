...
CC_nto_aarch64_gcc += -pipe $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(FORTIFY_DEFS) -Wall
...
CC_nto_aarch64_clang += -pipe $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(FORTIFY_DEFS) -Wall 
...
CC_nto_aarch64_gcc_qcc += $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(FORTIFY_DEFS) -Wc,-Wall
