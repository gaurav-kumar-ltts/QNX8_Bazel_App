...
#ifdef __EXT_QNX
ssize_t mq_clockreceive(mqd_t __mqdes, char *__msg_ptr, size_t __msg_len,
                        unsigned *__msg_prio, clockid_t __clk,
                        const struct timespec *__abs_timeout);
int mq_clocksend(mqd_t _mqdes, const char *__msg_ptr, size_t __msg_len,
                 unsigned __msg_prio, clockid_t __clk,
                 const struct timespec *__abs_timeout);
#endif
