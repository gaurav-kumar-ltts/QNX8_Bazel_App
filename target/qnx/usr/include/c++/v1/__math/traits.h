...
_LIBCPP_NODISCARD_EXT inline _LIBCPP_HIDE_FROM_ABI bool signbit(_A1 __x) _NOEXCEPT {
  ...
  return __fp_generic(__x, __signbitf, __signbit, __signbitl);
#else
...
#if defined(__QNX__) && !defined(QNX_LIBM_BUILTINS)
  return __fp_generic(__x, __isfinitef, __isfinite, __isfinitel);
#else
...
#if defined(__QNX__) && !defined(QNX_LIBM_BUILTINS)
  return __fp_generic(__x, __isinff, __isinf, __isinfl);
#else
...
#if defined(__QNX__) && !defined(QNX_LIBM_BUILTINS)
  return __fp_generic(__x, __inline_isnanf, __inline_isnan, __inline_isnanl);
#else
...
#if defined(__QNX__) && !defined(QNX_LIBM_BUILTINS)
  return __fp_generic(__x,  __isnormalf, __isnormal, __isnormall);
#else
