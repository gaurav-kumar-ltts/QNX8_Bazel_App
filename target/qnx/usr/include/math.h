/*
 * $QNXLicenseC:
 * Copyright 2016-2023, QNX Software Systems. All Rights Reserved.
 *
...
#if defined(__FLT_EVAL_METHOD__) && ((__FLT_EVAL_METHOD__-0) & 0xF) == 0
typedef double double_t;
typedef float float_t;
#elif ((__FLT_EVAL_METHOD__-0) & 0xF) == 1
typedef double double_t;
typedef double float_t;
#elif ((__FLT_EVAL_METHOD__-0) & 0xF) == 2
