 ...
 */
#define	AARCH64_PSTATE_nRW		((_Uint32t)1u << 4)
#define	AARCH64_PSTATE_F		((_Uint32t)1u << 6)
#define	AARCH64_PSTATE_I		((_Uint32t)1u << 7)
#define	AARCH64_PSTATE_A		((_Uint32t)1u << 8)
#define	AARCH64_PSTATE_D		((_Uint32t)1u << 9)
#define AARCH64_PSTATE_SSBS 	((_Uint32t)1u << 12)
#define	AARCH64_PSTATE_IL		((_Uint32t)1u << 20)
#define	AARCH64_PSTATE_SS		((_Uint32t)1u << 21)
#define	AARCH64_PSTATE_V		((_Uint32t)1u << 28)
#define	AARCH64_PSTATE_C		((_Uint32t)1u << 29)
#define	AARCH64_PSTATE_Z		((_Uint32t)1u << 30)
#define	AARCH64_PSTATE_N		((_Uint32t)1u << 31)
...
#define AARCH64_PSTATE_EL_SHIFT		(0x2u)
...
/* Careful: Daifset and Daifclr specify the bits at the lowest bit positions,
 * whereas PSTATE.DAIF (as returned via SPSR_ELx) has those bits located
 * starting from bit position 6.
 */
#define AARCH64_DAIFSET_AIF ((AARCH64_PSTATE_A |\
                              AARCH64_PSTATE_I |\
                              AARCH64_PSTATE_F) >> 6)
#define AARCH64_DAIFCLR_AIF AARCH64_DAIFSET_AIF
 ...
 */
#define	AARCH64_SCTLR_EL1_DSSBS	((_Uint64t)1u << 44)
#define	AARCH64_SCTLR_EL1_EnIA	((_Uint64t)1u << 31)
#define	AARCH64_SCTLR_EL1_EnIB	((_Uint64t)1u << 30)
#define	AARCH64_SCTLR_EL1_UCI	((_Uint64t)1u << 26)
#define	AARCH64_SCTLR_EL1_EE	((_Uint64t)1u << 25)
#define	AARCH64_SCTLR_EL1_E0E	((_Uint64t)1u << 24)
#define	AARCH64_SCTLR_EL1_WXN	((_Uint64t)1u << 19)
#define	AARCH64_SCTLR_EL1_nTWE	((_Uint64t)1u << 18)
#define	AARCH64_SCTLR_EL1_nTWI	((_Uint64t)1u << 16)
#define	AARCH64_SCTLR_EL1_UCT	((_Uint64t)1u << 15)
#define	AARCH64_SCTLR_EL1_DZE	((_Uint64t)1u << 14)
#define	AARCH64_SCTLR_EL1_I		((_Uint64t)1u << 12)
#define	AARCH64_SCTLR_EL1_UMA	((_Uint64t)1u << 9)
#define	AARCH64_SCTLR_EL1_SED	((_Uint64t)1u << 8)
#define	AARCH64_SCTLR_EL1_ITD	((_Uint64t)1u << 7)
#define	AARCH64_SCTLR_EL1_BEN	((_Uint64t)1u << 5)
#define	AARCH64_SCTLR_EL1_SA0	((_Uint64t)1u << 4)
#define	AARCH64_SCTLR_EL1_SA	((_Uint64t)1u << 3)
#define	AARCH64_SCTLR_EL1_C		((_Uint64t)1u << 2)
#define	AARCH64_SCTLR_EL1_A		((_Uint64t)1u << 1)
#define	AARCH64_SCTLR_EL1_M		((_Uint64t)1u << 0)
...
#define	AARCH64_ESR_EC_PAC		0x09u
...
#define	AARCH64_ESR_EC_PAC_FAIL		0x1cu
 ...
 */
#define	AARCH64_ESR_IABT(x)			(((unsigned)(x) & (4U << AARCH64_ESR_EC_SHIFT)) == 0U)
 ...
 * ISR_EL1 bits
 */
#define AARCH64_ISR_EL1_IS  (1UL << 10)
#define AARCH64_ISR_EL1_FS  (1UL << 9)
#define AARCH64_ISR_EL1_A   (1UL << 8)
#define AARCH64_ISR_EL1_I   (1UL << 7)
#define AARCH64_ISR_EL1_F   (1UL << 6)
