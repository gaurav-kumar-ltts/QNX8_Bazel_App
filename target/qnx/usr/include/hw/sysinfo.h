...
#define HWI_TAG_NAME_hwversion_ext16		"hwversion_ext16"
#define HWI_TAG_ALIGN_hwversion_ext16		(sizeof(_Uint32t))
struct hwi_hwversion_ext16 {
	struct hwi_prefix	prefix;
	_Uint16t			hclass;
	_Uint16t			version;
	_Uint16t			name;
...
typedef union {
	...
	struct hwi_hwversion_ext16	hwversion_ext16;
} hwi_tag;
