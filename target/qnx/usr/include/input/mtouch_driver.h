...
/**
*   @brief Update driver details to the Input Events framework
*
*   This function updates the Input Events framework with updated hardware
*   information.  This is useful for removable devices.
*   You need to re-configure @c params and @c funcs before passing them as
*   arguments to this function.
*
*   @param device The existing struct mtouch_device that was returned from
*                  mtouch_driver_attach.
*   @param params Updated parameters for your driver.
*
*   @return A handle to the opaque data type that represents the touch
*           device.
*/
struct mtouch_device* mtouch_driver_device_update(struct mtouch_device* device, mtouch_driver_params_t* params);
