...
#elif defined(VGO_nto)
#  define  VG_Z_LIBC_SONAME   libcZdsoZa              // libc.so*
#  define  VG_Z_LIBCPP_SONAME libcppZaZdsoZa          // libcpp*.so*
...
#elif defined(VGO_nto)
#  define  VG_Z_LIBPTHREAD_SONAME  VG_Z_LIBC_SONAME
#else
#  error "Unknown platform"
#endif
...
#define  VG_Z_LD_SO_3       libcZdsoZd3
#define  VG_U_LD_SO_3       "libc.so.3"
#define  VG_Z_LD_SO_4       libcZdsoZd4
#define  VG_U_LD_SO_4       "libc.so.4"
/* QNX7.1.0 */
/* libc /should/ no longer by a dynamic linker
 * see also coregrind/m_redir.c
   #define  VG_Z_LD_SO_5       libcZdsoZd5
   #define  VG_U_LD_SO_5       "libc.so.5" */
#define  VG_Z_LD_NTO_32       ldqnxZdsoZd2
#define  VG_U_LD_NTO_32       "ldqnx.so.2"
#define  VG_Z_LD_NTO_64       ldqnxZh64ZdsoZd2
#define  VG_U_LD_NTO_64       "ldqnx-64.so.2"
...
// NTO is c) no libpthread at all, everything in libc.
...
#elif defined(VGO_solaris) || defined(VGO_nto) || (defined(VGO_linux) && defined(MUSL_LIBC))
