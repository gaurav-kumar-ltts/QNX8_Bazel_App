...
#define PRICLOCK		__PRICLOCK		/* clock_t */
#define PRICLOCKID		__PRICLOCKID	/* clockid_t */
#define PRIDEV			__PRIDEV		/* dev_t */
#define PRIGID			__PRIGID		/* gid_t */
#define PRIID			__PRIID			/* id_t */
#define PRIINO			__PRIINO		/* ino_t */
#define PRIINO64		__PRIINO64		/* ino64_t */
#define PRIMODE			__PRIMODE		/* mode_t */
#define PRIOFF			__PRIOFF		/* off_t */
#define PRIOFF64		__PRIOFF64		/* off64_t */
#define PRIPID			__PRIPID		/* pid_t */
#define PRIPID64		__PRIPID64		/* pid64_t */
#define PRIPTHREAD		__PRIPTHREAD	/* pthread_t */
#define PRITIME			__PRITIME		/* time_t */
#define PRIUID			__PRIUID		/* uid_t */
#define PRIPADDR		__PRIPADDR		/* paddr_t */
...
#define SCNCLOCK		PRICLOCK	/* clock_t */
#define SCNCLOCKID		PRICLOCKID	/* clockid_t */
#define SCNDEV			PRIDEV		/* dev_t */
#define SCNGID			PRIGID		/* gid_t */
#define SCNID			PRIID		/* id_t */
#define SCNINO			PRIINO		/* ino_t */
#define SCNINO64		PRIINO64	/* ino64_t */
#define SCNMODE			PRIMODE		/* mode_t */
#define SCNOFF			PRIOFF		/* off_t */
#define SCNOFF64		PRIOFF64	/* off64_t */
#define SCNPID			PRIPID		/* pid_t */
#define SCNPTHREAD		PRIPTHREAD	/* pthread_t */
#define SCNTIME			PRITIME		/* time_t */
#define SCNUID			PRIUID		/* uid_t */
#define SCNPADDR		PRIPADDR	/* paddr_t */
