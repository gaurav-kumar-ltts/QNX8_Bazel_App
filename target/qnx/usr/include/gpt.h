...
/* Minimum space reserved for GPT partition entry array */
#define GPT_MIN_PEA_BYTES   16384
...
#define GPT_PTYPE_FL_USER  0x00000001U    /* User-defined partition type */
} gpt_ptype_t;
...
extern int gpt_calc_header_crc(uint32_t *pcrc, gpt_header_t *hdr);
...
extern int gpt_check_header(gpt_header_t *hdr);
