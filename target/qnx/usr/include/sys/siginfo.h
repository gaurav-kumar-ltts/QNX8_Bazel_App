...
#define SIGEV_SEM           9   /* notify, coid */
 ...
 */
# define SIGEV_GET_SIZE(__e)	(sizeof(struct sigevent))


/*
 * for SIGEV_PULSE set the receiving thread's priority to
 * the priority at which the process was created.
 */
