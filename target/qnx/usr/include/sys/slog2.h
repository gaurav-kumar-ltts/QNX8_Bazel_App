...
/**
  * Indicates an invalid verbosity, only returned by slog2_get_verbosity().
  */
#define SLOG2_INVALID_VERBOSITY ( (_Uint8t) -1 )

/**
  * Special purpose verbosity value. When this is passed to slog2_set_verbosity() or set as the
  * verbosity_level in slog2_buffer_set_config_t no logs will be written to the logging buffers.
  * Can also be returned by slog2_get_verbosity().
  */
#define SLOG2_NO_LOG_VERBOSITY  ( (_Uint8t) -2 )
...
#define SLOG2_DYNAMIC_VERBOSITY     (1<<10)  /* the internal logging verbosity check will use the verbosity */
                                             /* level within the buffer set rather than the locally cached  */
                                             /* value; this enables the capability of updating the logging  */
                                             /* verbosity level externally during the lifetime of the       */
                                             /* buffer set                                                  */
