...
typedef struct cam_devinfo {
    ...
    _Uint32t    xfer_len_max;         /* maximum transfer length in logical blocks */
    _Uint32t    xfer_len_optimal;     /* optimal transfer length in logical blocks */
    _Uint32t    xfer_len_granularity; /* optimal transfer length granularity in logical blocks */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/devb/cam/public/sys/cam_device.h $ $Rev: 901358 $")
#endif
