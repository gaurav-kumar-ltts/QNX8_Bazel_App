...
#define _DEBUG_STOP_REASON_FLAGS (_DEBUG_FLAG_SSTEP | _DEBUG_FLAG_TRACE_EXEC |\
...
#define _DEBUG_RUN_HOLD				0x00000008u	/* Deprecated: Hold mask flags interesting signals */
...
#define _DEBUG_RUN_SETSIG			0x00002000u /* Send signals in debug_run_t setsig field to process */
...
typedef struct _debug_process_info {
	...
	_Uint8t						reserved2[6];
	_Uint8t						extsched[8]; /* Deprecated & unused */
	...
	_Uint64t					rlimit_soft_core;	/* softlimit for core creation */
	_Uint64t					reserved[7];
}							debug_process_t;
...
typedef struct _debug_thread_info64 {
	...
	_Uint16t					last_cpu;
	_Uint32t					timeout;
	_Int32t						last_chid;	/* last_chid is deprecated */
	...
	union {
		// info32 and info64 are for backwards compat
		siginfo_t				info32;
		siginfo_t				info64;
		siginfo_t				info;
	};
...
#define _DEBUG_BREAK_SOFT		0x8000u	/* breakpoint achieved by replacing instruction */
