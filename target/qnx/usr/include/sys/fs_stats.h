...
struct fs_stats {
	...
	*/
	...
	uint64_t	s_syscall_acl;			/* Number of ACL calls				*/
	uint64_t	s_unblock_pulse;		/* Number of unblocks rcv (GLOBAL)	*/
	uint64_t	s_unblock_eintr;		/* Number of unblocks snd (GLOBAL)	*/

	uint64_t	s_nlba_trim;			/* Total LBA trimmed or discarded	*/
