...
/* #define DCMD_FSYS_FSEVMGR_CHECK     __DION(_DCMD_FSYS,  23)  (removed along with fsevents)*/
...
/* #define DCMD_FSYS_FSNOTIFY_SAVE		__DIOT(_DCMD_FSYS,  34, fs_fsnotify_save_t) (can be reclaimed) */
...
/* Version selectors to query for devctl(DCMD_FSYS_VERSION) */
enum {
	FSYS_VERSION_ROLLBACK = 1,
};
