/*
 * $QNXLicenseC:
 * Copyright 2007, 2009, 2023, QNX Software Systems. All Rights Reserved.
 *
...
enum {
    ...
    IMAGE_FLAGS_SORTED      = 0x08, /* dirent section is sorted (by pathname) */
    IMAGE_FLAGS_TRAILER_V2  = 0x10, /* image uses struct image_trailer_v2 */
};
...
/* NOTE: The checksums in this trailer will only be valid until    */
/* the first non-startup bootstrap binary (e.g., startup-verifier, */
/* procnto, ...) is invoked. Because bootstrap binaries execute    */
/* in-place, their data segments will change once the programs     */
/* are running. Hence, any checksum validation would need to be    */
/* done either by the boot loader / IFS or by the startup.         */
struct image_trailer_v2 {
...
#define SCRIPT_FLAGS_CRITICAL	0x80
