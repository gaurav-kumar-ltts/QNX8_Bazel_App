/*
 * Copyright (c) 2007, 2023, BlackBerry Limited. All rights reserved.
 *
...
typedef enum {
	...
	_TRACEPARSER_INVALID_DATA,            /* 15 - invalid/corrupt data                    */
	_TRACEPARSER_NOT_SEEKABLE,            /* 16 - input stream is not seekable            */
	_TRACEPARSER_UNKNOWN_ERROR            /* 17 - unknown error                           */
} traceparser_error_t;
...
extern void  traceparser_sort(struct traceparser_state* __state_ptr, unsigned __sort);
