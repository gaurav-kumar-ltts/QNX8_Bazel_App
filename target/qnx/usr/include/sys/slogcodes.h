...
#define _SLOGC_PPS              29 // deprecated
...
#define _SLOGC_SECURITY_PLATFORM    41
 ...
 #define _SLOGC_SEC_CERTMGR_PPS      __C(_SLOGC_SECURITY_PLATFORM, 600) // deprecated
...
#define _SLOGC_I2C              51

#define _SLOGC_SPI              52
#define _SLOGC_SPI_MASTER               __C(_SLOGC_SPI, 0)
#define _SLOGC_SPI_SLAVE                __C(_SLOGC_SPI, 100)

#define _SLOGC_FLASH            53
#define _SLOGC_FLASH_QSPI               __C(_SLOGC_FLASH, 0)
#define _SLOGC_FLASH_SPI                __C(_SLOGC_FLASH, 100)

#define _SLOGC_CAN              54

/* Add the next MAJOR code here.
#define _SLOGC_NEXT_QNX         55
*/
