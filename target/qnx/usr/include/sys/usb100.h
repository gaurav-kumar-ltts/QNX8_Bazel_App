/*
 * Copyright (c) 2005-2026, BlackBerry Limited. All rights reserved.
 *
...
#define USB_ENDPOINT_DIRECTION_MASK         ( (uint8_t) 0x80U )
#define USB_ENDPOINT_DIRECTION( epaddr )    ( epaddr & USB_ENDPOINT_DIRECTION_MASK )
    #define USB_ENDPOINT_IN                 ( (uint8_t) 0x80U )
    #define USB_ENDPOINT_OUT                ( (uint8_t) 0x00U )
#define USB_ENDPOINT_DIR_IN( epdir )        ( USB_ENDPOINT_DIRECTION((epdir)) == USB_ENDPOINT_IN )

#define USB_ENDPOINT_ATTRIB_ETYPE_MASK      ( (uint8_t) 0x03U )
#define USB_ENDPOINT_TYPE( epattr )         (epattr & USB_ENDPOINT_ATTRIB_ETYPE_MASK)
    #define USB_ATTRIB_CONTROL              ( (uint8_t) 0x00U )
    #define USB_ATTRIB_ISOCHRONOUS          ( (uint8_t) 0x01U )
    #define USB_ATTRIB_BULK                 ( (uint8_t) 0x02U )
    #define USB_ATTRIB_INTERRUPT            ( (uint8_t) 0x03U )
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/trunk/lib/usbdiotg/usbdi/public/sys/usb100.h $ $Rev: 977663 $")
#endif
