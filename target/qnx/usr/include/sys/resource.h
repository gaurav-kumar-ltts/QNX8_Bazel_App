...
#define RLIMIT_CHANNELS_NP    14   /* maximum number of channels created by a process */
#define RLIMIT_SHM_HANDLES_NP 15   /* maximum number of concurrent shmem handles created
                                    * by a process and not yet consumed */
#define RLIMIT_MQUEUE_SIZE_NP 16   /* maximum total size in bytes of created-and-still-referenced mqueues */
#define RLIMIT_MQUEUE_NUM_NP  17   /* maximum number of created-and-still-referenced mqueues */
#define RLIMIT_SYNC_NP		  18   /* maximum number of persistent sync objects */
#define RLIM_NLIMITS          19   /* number of resource limits */
