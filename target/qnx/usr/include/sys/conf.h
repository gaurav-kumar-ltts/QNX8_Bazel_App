...
/* Functions */
#define _CONF_NOP				0x00000U	/* Do nothing entry */
#define _CONF_LINK				0x10000U	/* table continues here */
#define _CONF_CALL				0x20000U	/* See if function will match */
#define _CONF_VALUE				0x30000U	/* Contains a value to match */
#define _CONF_END				0x40000U	/* End of table */
#define _CONF_CMD_MASK			0xf0000U

/* Conditions (bits) */
#define _CONF_STR				0x100000U	/* Only use entry if checking for string */
#define _CONF_NUM				0x200000U	/* Only use entry if checking for number */
#define _CONF_COND_MASK			0xf00000U

/* Value modifiers (bits) */
#define _CONF_NUM_MIN			0x1000000U
#define _CONF_NUM_MAX			0x2000000U
#define _CONF_NUM_ADD			0x3000000U
#define _CONF_MOD_MASK			0xf000000U

/* Flags (bits) */
#define _CONF_STICKY			0x10000000U	/* Used by library to make conf outlive the process */
#define _CONF_INDIRECT			0x20000000U	/* Indirect pointer */
#define _CONF_FCN				0x40000000U	/* Call function */
#define _CONF_FLAGS_MASK		0xf0000000U
