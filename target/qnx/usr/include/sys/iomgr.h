 ...
 * Passed to iofdinfo()
 */
#define _FDINFO_FLAG_LOCALPATH	0x00000001U	/* Used to return smaller path for displaying */
#define _FDINFO_FLAG_NOPATH		0x00000002U	/* Don't require path or path size */
...
struct _fdinfo {
	...
	_Uint64t					filehandle;		/* File identity unique to the namespace of the host */
	_Uint32t					inodegen;		/* inode generation; to be able to detect inode reuse */
	_Uint32t					zero[3];
};
