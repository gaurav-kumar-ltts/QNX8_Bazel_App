...
# define POSIX_SPAWN_SETCONTAINERID  0x00200000  /* Set the container identifier */
...
extern int posix_spawnattr_getrunmask(const posix_spawnattr_t *_Restrict __attrp, _Uint32t *_Restrict __runmask_p) __attribute__ ((deprecated));
extern int posix_spawnattr_setrunmask(posix_spawnattr_t *__attrp, _Uint32t __runmask) __attribute__ ((deprecated));
extern int pthread_spawnattr_getrunmask_np(const posix_spawnattr_t *_Restrict __attrp, _Uint64t *_Restrict __runmask_p);
extern int pthread_spawnattr_setrunmask_np(posix_spawnattr_t *__attrp, _Uint64t __runmask);
...
extern int posix_spawnattr_setcontainerid_np(posix_spawnattr_t * const attrp, const cid_t cid);
...
#define __INHERIT_FIELDS(__sched_type)														\
    ...
    _Uint64t                    runmask;    /* SPAWN_EXPLICIT_CPU must be set in flags */	\
