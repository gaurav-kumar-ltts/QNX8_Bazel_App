...
#define SCHED_HIGH_PRIORITY_IST  8
#define SCHED_OFFLINING 9
#define SCHED_MAXPOLICY 9	/* Maximum valid policy entry */
...
enum {
	...
	// Backwards compatibility with 8.0
	SCHED_PROCESSOR_ONLINE = (SCHED_EXT_CMD_BASE + 4),
	SCHED_PROCESSOR_OFFLINE,
	SCHED_PROCESSORS_STATUS
};

struct _sched_processors_status {
	_Uint32t num_processors;
	_Uint32t num_processors_online;
	_Uint64t processors_online[1];
};
