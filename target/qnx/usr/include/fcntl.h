...
#define O_PERMCHECK	02000000 /* Permissions check by means of an open (allows creating writable directory OCBs) */
...
#if __OFF_BITS__ == 64
#define _F_OFF       100
#define _F_LF64_OFF  0
#elif __OFF_BITS__ == 32
#define _F_OFF       0
#define _F_LF64_OFF  100
#else
 #error __OFF_BITS__ value is unsupported
#endif

#define F_SETLK     (_F_OFF + 6)  /*  Set record locking info */
#define F_SETLKW    (_F_OFF + 7)  /*  Set record locking info */
#define F_ALLOCSP   (_F_OFF + 10) /*  Allocate space (posix_fallocate semantics) */
#define F_FREESP    (_F_OFF + 11) /*  Shrink/Deallocate space */
#define F_GETLK     (_F_OFF + 14) /*  Get record locking info */
#define F_GROWSP    (_F_OFF + 9)  /*  Grow space (ftruncate semantics) */

#ifdef __EXT_LF64SRC
#define F_SETLK64   (_F_LF64_OFF + F_SETLK)
#define F_SETLKW64  (_F_LF64_OFF + F_SETLKW)
#define F_ALLOCSP64 (_F_LF64_OFF + F_ALLOCSP)
#define F_FREESP64  (_F_LF64_OFF + F_FREESP)
#define F_GETLK64   (_F_LF64_OFF + F_GETLK)
#define F_GROWSP64  (_F_LF64_OFF + F_GROWSP)
#endif
...
#define F_DUP2FD    37  /* Same as DUPFD, but returns exactly the target fd, detaching if need be */
/*
...
#define F_FLOCK  0x80       /* enforce OCB-based locking semantics rather than pid-based */
#endif
