...
enum opt_code
{
  ...
  OPT_mharden_sls_ = 1783,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1784,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1785,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1786,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1787,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1788,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1789,               /* -moutline-atomics */
  OPT_moverride_ = 1790,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1791,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1792,          /* -msign-return-address= */
  ...
  OPT_msve_vector_bits_ = 1797,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1798,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1799,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1800,             /* -mtrack-speculation */
  ...
  OPT_rpath_link = 1845,                     /* -rpath-link */
  OPT_rpath_link_ = 1846,                    /* -rpath-link= */
  OPT_rpath_ = 1847,                         /* -rpath= */
  OPT_s = 1848,                              /* -s */
