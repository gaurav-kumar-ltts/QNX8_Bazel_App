...
enum opt_code
{
  ...
  OPT_Wmissing_template_keyword = 659,       /* -Wmissing-template-keyword */
  ...
  OPT_list = 1765,                           /* -list */
  OPT_m128bit_long_double = 1766,            /* -m128bit-long-double */
  OPT_m16 = 1767,                            /* -m16 */
  OPT_m32 = 1768,                            /* -m32 */
  OPT_m3dnow = 1769,                         /* -m3dnow */
  OPT_m3dnowa = 1770,                        /* -m3dnowa */
  OPT_m64 = 1771,                            /* -m64 */
  OPT_m80387 = 1772,                         /* -m80387 */
  OPT_m8bit_idiv = 1773,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1774,             /* -m96bit-long-double */
  OPT_mabi_ = 1775,                          /* -mabi= */
  OPT_mabm = 1776,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1777,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1778,                 /* -maddress-mode= */
  OPT_madx = 1779,                           /* -madx */
  OPT_maes = 1780,                           /* -maes */
  OPT_malign_data_ = 1781,                   /* -malign-data= */
  OPT_malign_double = 1782,                  /* -malign-double */
  OPT_malign_functions_ = 1783,              /* -malign-functions= */
  OPT_malign_jumps_ = 1784,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1785,                  /* -malign-loops= */
  OPT_malign_stringops = 1786,               /* -malign-stringops */
  OPT_mamx_bf16 = 1787,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1788,                      /* -mamx-int8 */
  OPT_mamx_tile = 1789,                      /* -mamx-tile */
  ...
  OPT_mbmi = 1815,                           /* -mbmi */
  OPT_mbmi2 = 1816,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1817,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1818,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1819,                    /* -mcet-switch */
  OPT_mcld = 1820,                           /* -mcld */
  OPT_mcldemote = 1821,                      /* -mcldemote */
  OPT_mclflushopt = 1822,                    /* -mclflushopt */
  OPT_mclwb = 1823,                          /* -mclwb */
  OPT_mclzero = 1824,                        /* -mclzero */
  OPT_mcmodel_ = 1825,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1826, */                    /* -mcpu= */
  OPT_mcrc32 = 1827,                         /* -mcrc32 */
  OPT_mcx16 = 1828,                          /* -mcx16 */
  OPT_mdirect_extern_access = 1829,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1830,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1831,            /* -mdump-tune-features */
  OPT_menqcmd = 1832,                        /* -menqcmd */
  OPT_mf16c = 1833,                          /* -mf16c */
  OPT_mfancy_math_387 = 1834,                /* -mfancy-math-387 */
  OPT_mfentry = 1835,                        /* -mfentry */
  OPT_mfentry_name_ = 1836,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1837,               /* -mfentry-section= */
  OPT_mfma = 1838,                           /* -mfma */
  OPT_mfma4 = 1839,                          /* -mfma4 */
  OPT_mforce_drap = 1840,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1841,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1842,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1843,                       /* -mfpmath= */
  OPT_mfsgsbase = 1844,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1845,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1846, */              /* -mfused-madd */
  OPT_mfxsr = 1847,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1848,             /* -mgeneral-regs-only */
  OPT_mgfni = 1849,                          /* -mgfni */
  OPT_mhard_float = 1850,                    /* -mhard-float */
  OPT_mharden_sls_ = 1851,                   /* -mharden-sls= */
  OPT_mhle = 1852,                           /* -mhle */
  OPT_mhreset = 1853,                        /* -mhreset */
  OPT_miamcu = 1854,                         /* -miamcu */
  OPT_mieee_fp = 1855,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1856,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1857,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1858,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1859,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1860,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1861,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1862,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1863, */            /* -mintel-syntax */
  OPT_mkl = 1864,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1865,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1866,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1867,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1868,                /* -mlong-double-80 */
  OPT_mlwp = 1869,                           /* -mlwp */
  OPT_mlzcnt = 1870,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1871,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1872,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1873,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1874,                  /* -mmitigate-rop */
  OPT_mmmx = 1875,                           /* -mmmx */
  OPT_mmovbe = 1876,                         /* -mmovbe */
  OPT_mmovdir64b = 1877,                     /* -mmovdir64b */
  OPT_mmovdiri = 1878,                       /* -mmovdiri */
  OPT_mmove_max_ = 1879,                     /* -mmove-max= */
  OPT_mmpx = 1880,                           /* -mmpx */
  OPT_mms_bitfields = 1881,                  /* -mms-bitfields */
  OPT_mmwait = 1882,                         /* -mmwait */
  OPT_mmwaitx = 1883,                        /* -mmwaitx */
  OPT_mneeded = 1884,                        /* -mneeded */
  OPT_mno_align_stringops = 1885,            /* -mno-align-stringops */
  OPT_mno_default = 1886,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1887,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1888,                  /* -mno-push-args */
  OPT_mno_red_zone = 1889,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1890,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1891,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1892,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1893,                          /* -mpc32 */
  OPT_mpc64 = 1894,                          /* -mpc64 */
  OPT_mpc80 = 1895,                          /* -mpc80 */
  OPT_mpclmul = 1896,                        /* -mpclmul */
  OPT_mpcommit = 1897,                       /* -mpcommit */
  OPT_mpconfig = 1898,                       /* -mpconfig */
  OPT_mpku = 1899,                           /* -mpku */
  OPT_mpopcnt = 1900,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1901, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1902,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1903,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1904,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1905,                        /* -mprfchw */
  OPT_mptwrite = 1906,                       /* -mptwrite */
  OPT_mpush_args = 1907,                     /* -mpush-args */
  OPT_mrdpid = 1908,                         /* -mrdpid */
  OPT_mrdrnd = 1909,                         /* -mrdrnd */
  OPT_mrdseed = 1910,                        /* -mrdseed */
  OPT_mrecip = 1911,                         /* -mrecip */
  OPT_mrecip_ = 1912,                        /* -mrecip= */
  OPT_mrecord_mcount = 1913,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1914,                 /* -mrecord-return */
  OPT_mred_zone = 1915,                      /* -mred-zone */
  OPT_mregparm_ = 1916,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1917,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1918,                           /* -mrtd */
  OPT_mrtm = 1919,                           /* -mrtm */
  OPT_msahf = 1920,                          /* -msahf */
  OPT_mserialize = 1921,                     /* -mserialize */
  OPT_msgx = 1922,                           /* -msgx */
  OPT_msha = 1923,                           /* -msha */
  OPT_mshstk = 1924,                         /* -mshstk */
  OPT_mskip_rax_setup = 1925,                /* -mskip-rax-setup */
  OPT_msoft_float = 1926,                    /* -msoft-float */
  OPT_msse = 1927,                           /* -msse */
  OPT_msse2 = 1928,                          /* -msse2 */
  OPT_msse2avx = 1929,                       /* -msse2avx */
  OPT_msse3 = 1930,                          /* -msse3 */
  OPT_msse4 = 1931,                          /* -msse4 */
  OPT_msse4_1 = 1932,                        /* -msse4.1 */
  OPT_msse4_2 = 1933,                        /* -msse4.2 */
  OPT_msse4a = 1934,                         /* -msse4a */
  /* OPT_msse5 = 1935, */                    /* -msse5 */
  OPT_msseregparm = 1936,                    /* -msseregparm */
  OPT_mssse3 = 1937,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1938,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 1941, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1942,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1943,                  /* -mstackrealign */
  OPT_mstore_max_ = 1944,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1945,            /* -mstringop-strategy= */
  OPT_mstv = 1946,                           /* -mstv */
  OPT_mtbm = 1947,                           /* -mtbm */
  OPT_mtls_dialect_ = 1948,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1949,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1950,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1951,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1952,                         /* -mtune= */
  OPT_muintr = 1953,                         /* -muintr */
  OPT_mvaes = 1954,                          /* -mvaes */
  OPT_mveclibabi_ = 1955,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1956,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1957,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1958,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1959,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1960,                      /* -mwbnoinvd */
  OPT_mwidekl = 1961,                        /* -mwidekl */
  OPT_mx32 = 1962,                           /* -mx32 */
  OPT_mxop = 1963,                           /* -mxop */
  OPT_mxsave = 1964,                         /* -mxsave */
  OPT_mxsavec = 1965,                        /* -mxsavec */
  OPT_mxsaveopt = 1966,                      /* -mxsaveopt */
  OPT_mxsaves = 1967,                        /* -mxsaves */
  OPT_n = 1968,                              /* -n */
  ...
  /* OPT_nopie = 1977, */                    /* -nopie */
  OPT_nostartfiles = 1978,                   /* -nostartfiles */
  OPT_nostdinc = 1979,                       /* -nostdinc */
  OPT_nostdinc__ = 1980,                     /* -nostdinc++ */
  OPT_nostdlib = 1981,                       /* -nostdlib */
  OPT_o = 1982,                              /* -o */
  ...
  OPT_pthread = 2004,                        /* -pthread */
  OPT_quiet = 2005,                          /* -quiet */
  OPT_r = 2006,                              /* -r */
  OPT_rdynamic = 2007,                       /* -rdynamic */
  OPT_remap = 2008,                          /* -remap */
  OPT_reverse_sort = 2009,                   /* -reverse-sort */
  OPT_rpath_link = 2010,                     /* -rpath-link */
  OPT_rpath_link_ = 2011,                    /* -rpath-link= */
  OPT_rpath_ = 2012,                         /* -rpath= */
  OPT_s = 2013,                              /* -s */
  ...
  OPT_static_libstdc__ = 2032,               /* -static-libstdc++ */
  OPT_static_libtsan = 2033,                 /* -static-libtsan */
  OPT_static_libubsan = 2034,                /* -static-libubsan */
  OPT_static_pie = 2035,                     /* -static-pie */
  /* OPT_std_c__03 = 2036, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2037, */                /* -std=c++0x */
  OPT_std_c__11 = 2038,                      /* -std=c++11 */
  OPT_std_c__14 = 2039,                      /* -std=c++14 */
  OPT_std_c__17 = 2040,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2041, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2042, */                /* -std=c++1z */
  OPT_std_c__20 = 2043,                      /* -std=c++20 */
  OPT_std_c__23 = 2044,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2045, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2046, */                /* -std=c++2b */
  ...
  OPT_std_c2x = 2052,                        /* -std=c2x */
  /* OPT_std_c89 = 2053, */                  /* -std=c89 */
  OPT_std_c90 = 2054,                        /* -std=c90 */
  OPT_std_c99 = 2055,                        /* -std=c99 */
  /* OPT_std_c9x = 2056, */                  /* -std=c9x */
  OPT_std_f2003 = 2057,                      /* -std=f2003 */
  OPT_std_f2008 = 2058,                      /* -std=f2008 */
  OPT_std_f2008ts = 2059,                    /* -std=f2008ts */
  OPT_std_f2018 = 2060,                      /* -std=f2018 */
  OPT_std_f95 = 2061,                        /* -std=f95 */
  OPT_std_gnu = 2062,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2063, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2064, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2065,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2066,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2067,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2068, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2069, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2070,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2071,                    /* -std=gnu++23 */
